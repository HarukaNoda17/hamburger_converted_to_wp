...
<main class="l-main">
    <article class="p-visual__page">
        <section class="p-visual__page--main">
            <h2 class="c-title--main c-font-color--white c-font-family--mplus1 c-font-weight--bold"> ヒストリー</h2>
        </section>
        ...
        <section class="p-visual__single--sub">
            <div class="first-block">
                ...
                <figure class="first-block__middle02">
                    ...
                    <img class="first-block__middle02--img" src="<?php echo get_theme_file_uri('/images/single/img_single.png'); ?>" alt="チーズバーガーの画像">
                </figure>
                <figure class="first-block__bottom">
                    <img class="first-block__bottom--img" src="<?php echo get_theme_file_uri('/images/single/img_single.png'); ?>" alt="チーズバーガーの画像">
                </figure>
            </div>
